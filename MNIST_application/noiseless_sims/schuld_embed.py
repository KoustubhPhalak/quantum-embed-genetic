'''
Code for trainable QAOA embedding used for loading MNIST data in QNN.
'''
...
# Define the quantum circuit. Schuld embedding is trainable QAOA embedding.
@qml.qnode(dev, interface='torch')
def qcircuit(inputs,emb_params, params):
    qml.templates.QAOAEmbedding(inputs[:,:4],emb_params,wires=range(n_qubits))
...
weight_shapes = {"params": (n_layers, n_qubits, 3), "emb_params": (2, n_features)}
