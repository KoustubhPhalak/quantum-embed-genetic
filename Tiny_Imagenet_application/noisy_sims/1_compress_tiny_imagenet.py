'''
Compress tiny-imagenet dataset to 16 dimensions using UMAP
'''
...
# first_two_classes = ['n07720875', 'n07747607'] # bell pepper, orange
first_two_classes = ['n02281406', 'n09193705'] # sulphur butterfly, alp
...
umap_model = umap.UMAP(n_components=16, n_neighbors=15, min_dist=0.1, random_state=123)
...
np.save("reduced_images_hi.npy",reduced_data)
np.save("labels_hi.npy",labels)
